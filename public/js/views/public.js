      ...
      <div class="container hero-grid">
        <div>
          ...
          <div class="hero-actions">
            <a class="btn btn-primary btn-lg" href="/strategies" data-nav>Browse strategies</a>
      ...
      <div class="container">
        ...
        <div class="grid-4">
          <div class="card step">
            ...
            <p>Pick the platforms you create for — single, combined or custom.</p>
          </div>
          <div class="card step">
            <span class="ic">${icon('box', 20)}</span>
            <span class="num">02</span>
            <h3>Place your order</h3>
            <p>Create a free streamer account and place your order. You only pay for the strategy itself.</p>
          </div>
          <div class="card step">
            <span class="ic">${icon('payments', 20)}</span>
            <span class="num">03</span>
            <h3>Confirm your payment</h3>
            <p>Pay by your preferred method, then report it from your dashboard. Agbota Segun confirms it personally.</p>
          </div>
          <div class="card step">
            <span class="ic">${icon('chat', 20)}</span>
            <span class="num">04</span>
            <h3>Get your strategy + support</h3>
            <p>Receive your strategy and keep the conversation open in chat for questions and adjustments.</p>
          </div>
        </div>
      </div>
    </section>
